...
public class BitmapUtil {
    ...
    public static boolean saveImage(Bitmap bitmap, String absPath) throws IOException {
        return saveImage(bitmap, absPath, 100);
    }

    public static boolean saveImage(Bitmap bitmap, String absPath, int quality) throws IOException {
    ...
    public static Bitmap toRoundCorner(Context context, Bitmap bitmap) {
        try {
            ...
            Drawable drawable = getDrawable(0xffffffff, (int) (delta + roundPx));
    ...
    public final static GradientDrawable getDrawable(int argb, int radius) {
