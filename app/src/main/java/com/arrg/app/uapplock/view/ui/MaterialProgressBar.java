...
package com.arrg.app.uapplock.view.ui;
...
public class MaterialProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackGroundColor = a.getColor(
                R.styleable.MaterialProgressBar_background_color, ContextCompat.getColor(context, R.color.colorPrimary));

        mProgressColor = a.getColor(
                R.styleable.MaterialProgressBar_progress_color, ContextCompat.getColor(context, R.color.colorAccent));
