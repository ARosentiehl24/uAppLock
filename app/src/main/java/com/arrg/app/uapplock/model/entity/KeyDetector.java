...
public class KeyDetector {
    ...
    class KeyReceiver extends BroadcastReceiver {
        ...
        final String SYSTEM_DIALOG_REASON_GLOBAL_ACTIONS = "Global Actions";
        final String SYSTEM_DIALOG_REASON_RECENT_APPS = "Recent Apps";
        final String SYSTEM_DIALOG_REASON_HOME_KEY = "Home Key";
